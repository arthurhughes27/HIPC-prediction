cv.predict.elasticnet = function(df,
  ...
  if (n.cores > 1) {
    ...
    on.exit({
      if (cluster_created && !cluster_stopped) {
  ...
  if (baseline) {
    metrics <- data.frame(
      ...
      "feature.selection.metric.threshold" = ifelse(
        feature.selection == "none",
        0,
        feature.selection.metric.threshold
      ),
    ...
    metrics <- data.frame(
      ...
      "feature.selection.metric" = ifelse(
        feature.selection == "none",
        "none",
      ...
      "feature.selection.model" = ifelse(
        feature.selection == "none",
        "none",
        feature.selection.model
      ),
      "feature.selection.criterion" = ifelse(
        feature.selection == "none",
        "none",
